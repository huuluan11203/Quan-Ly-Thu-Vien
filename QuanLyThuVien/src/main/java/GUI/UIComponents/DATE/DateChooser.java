...
//        });
    ...
    private void initComponents() {
        ...
        cmdForward = new GUI.UIComponents.DATE.Button();
        MY = new javax.swing.JLayeredPane();
        cmdMonth = new GUI.UIComponents.DATE.Button();
        lb = new javax.swing.JLabel();
        cmdYear = new GUI.UIComponents.DATE.Button();
        cmdPrevious = new GUI.UIComponents.DATE.Button();
        slide = new GUI.UIComponents.DATE.Slider();

        setBackground(new java.awt.Color(255, 255, 255));

        header.setBackground(new java.awt.Color(55, 134, 239));
        header.setMaximumSize(new java.awt.Dimension(262, 40));

        cmdForward.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        cmdForward.setIcon(new javax.swing.ImageIcon(getClass().getResource("/IMG/icon/forward.png"))); // NOI18N
        ...
        cmdPrevious.setIcon(new javax.swing.ImageIcon(getClass().getResource("/IMG/icon/previous.png"))); // NOI18N
        ...
        headerLayout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, headerLayout.createSequentialGroup()
                ...
                .addComponent(MY, javax.swing.GroupLayout.DEFAULT_SIZE, 122, Short.MAX_VALUE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGap(0, 0, 0)
                .addComponent(slide, javax.swing.GroupLayout.PREFERRED_SIZE, 120, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(0, 0, Short.MAX_VALUE))
        );
    ...
    private GUI.UIComponents.DATE.Button cmdForward;
    private GUI.UIComponents.DATE.Button cmdMonth;
    private GUI.UIComponents.DATE.Button cmdPrevious;
    private GUI.UIComponents.DATE.Button cmdYear;
    private javax.swing.JPanel header;
    private javax.swing.JLabel lb;
    private javax.swing.JPopupMenu popup;
    private GUI.UIComponents.DATE.Slider slide;
